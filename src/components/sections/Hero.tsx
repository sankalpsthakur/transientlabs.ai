...
export function Hero() {
    ...
    return (
        ...
        >
                    ...
                    <div className="max-w-3xl lg:max-w-[42rem]">
                        ...
                        <FadeIn delay={0.08}>
                            ...
                            <p className="mt-4 max-w-2xl text-sm font-medium tracking-wide text-ink-muted md:text-base">
                                Every engagement starts as a bounded Sprint.
                            </p>
                        </FadeIn>
            ...
            {/* Scroll-down indicator. Static — a chevron that bobs forever is the
                loudest thing on an otherwise quiet page. */}
            <div className="absolute bottom-8 left-1/2 hidden -translate-x-1/2 lg:block">
                <ChevronDown className="h-6 w-6 text-ink-muted opacity-40" aria-hidden="true" />
            </div>
        </section>
    );
}
